...
export default class Project extends ParseObject {
  ...
  get description() { return this.instance.get('description'); }
  set description(val) { return this.instance.set('description'); }

  get startDate() { return this.instance.get('startDate'); }
  set startDate(val) { return this.instance.set('startDate', moment(val).utc().toDate()); }

  get endDate() { return this.instance.get('endDate'); }
  set endDate(val) { return this.instance.set('endDate', moment(val).utc().toDate()); }
